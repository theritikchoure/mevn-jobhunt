<template>
  <layout>
    <template v-slot:section>
      <section>
        <PageBreadcrumb :link="{name: 'About Us'}" />
      </section>
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-7">
                      <p>
                        ...
                        glowered inset one echidna cassowary some parrot and
                        much as goodness some froze the sullen much connected
                        bat wonderfully on instantaneously eel valiantly petted
                        this along across highhandedly much.
                      </p>
                      <p>
                        ...
                        abidingly up above fitting to strident wiped set
                        waywardly far the and pangolin horse approving paid
                        chuckled cassowary oh above a much opposite far much
                        hypnotically more therefore wasp less that hey apart
                        well like while superbly orca and far hence one.Far much
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                      <div class="service">
                        ...
                        <div class="service-info">
                          ...
                          <p>
                            Duis a tristique lacus. Donec vehicula ante id lorem
                            venenatis posuere. Morbi in lectus.
                          </p>
                        </div>
                      </div>
                    </div>
